...
function Options() {
  ...
  return (
    <div className='flex w-full md:w-fit gap-5 p-5 flex-row absolute bottom-0 left-0 rounded-xl justify-around bg-white sm:static md:pe-20 sm:flex-col sm:w-fit sm:justify-normal z-10'>
