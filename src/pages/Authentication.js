...
const Authentication = ({ register, setAuth }) => {
    ...
    return (
        <div class="min-w-screen min-h-screen bg-gray-700 flex items-center justify-center px-5 py-5">
            <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl lg:w-1/2 md:w-2/3 w-full overflow-hidden " >
                <div class="md:flex w-full">
                    ...
                    <div class="w-full md:w-1/2 py-5 px-5 md:px-10">
                        <div class="text-center mb-5">
                            <h1 class="font-bold text-3xl text-gray-900">{register ? "Create an Account" : "Login Here"}</h1>
                        ...
                        <div>
                                ...
                                <div class="flex -mx-3">
                                    <div class="w-full px-3 mb-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Fullname" name='fullName' onChange={handleInput} />
                                        </div>
                                    </div>
                                </div>
                                <div class="flex -mx-3">
                                    <div class="w-full px-3 mb-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            <input type="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Email" name='email' onChange={handleInput} />
                                        </div>
                                    </div>
                                </div>
                            </>}
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                        <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Username" name='username' onChange={handleInput} />
                                    </div>
                                </div>
                            </div>
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-12">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="password" name='password' onChange={handleInput} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <button class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold" onClick={register ? handleRegister : handleLogin} disabled={loading}>
                                    {loading ? "Loading..." : register ? "Create an Account" : "Login"}</button>
                                </div>
                            </div>
